...
import {
    ...
    faCheck, faCommentAlt, faShare, faBuildingUser, faXmark, faCheckCircle, faTimesCircle, faHome
...
export default function Navbar() {
    ...
    const {
        notifications,
        unreadCount,
        loading: notificationLoading, // Đổi tên từ loading thành notificationLoading để phù hợp với Navbar.jsx
        hasMore,
        pageNumber,
        userInfoMap,
        showingUnreadOnly,
    ...
    const renderNotification = (notification, index) => {
        // Lấy userId từ senderid (người gửi) thay vì accountId (người nhận)
        const userId = notification.senderID || notification.senderid || notification.senderId || notification.accountId;
        // Chỉ lấy thông tin từ userInfoMap, không fallback về notification.userInfo vì có thể sai người
