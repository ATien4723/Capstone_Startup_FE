...
const menu = [
    { label: "Bài viết", icon: faNewspaper, to: "/posts" },
    { label: "Chat", icon: faComments, to: "/chat" },
    { label: "Công việc", icon: faTasks, to: "/tasks" },
    { label: "Lịch", icon: faCalendarAlt, to: "/calendar" },
    { label: "Ứng viên", icon: faUserTie, to: "/candidates" },
    { label: "Thành viên", icon: faUsers, to: "/members" },
];
