...
app.MapHub<NotificationHub> ("/api/hubs/notification").RequireCors ("AllowAll");
// Configure the HTTP request pipeline.
app.MapHub<MessageHub> ("/api/messagehub").RequireCors ("AllowAll");
app.MapHub<CallHub>("/api/callhub").RequireCors("AllowAll");
